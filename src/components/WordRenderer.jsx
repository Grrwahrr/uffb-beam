        ...
        <div style={{ position: 'relative', width: '100%', height: '100vh', background: 'black' }}>
            ...
            <div onMouseDown={stopMouse} style={{ position: 'absolute', left: 12, top: 12, zIndex: 20, color: 'white', fontFamily: 'sans-serif' }}>
                <input value={inputValue} onChange={handleInputChange} onKeyDown={handleInputKeyDown}
                    placeholder={`Type a word, press Enter`} style={{ padding: 8, borderRadius: 6, border: '1px solid rgba(255,255,255,0.18)', background: 'rgba(0,0,0,0.4)', color: 'white' }} />
                <div style={{ fontSize: 12, opacity: 0.8, marginTop: 6, display: "none" }}>Custom bucket used every {cfg.customEvery}th spawn. Next overwrite: #{1 + (overwriteCounterRef.current % 4)}</div>
