                    ...
                    <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                cfg.enableAudio = e.target.checked;
                            }}
                            style={{ marginRight: 6 }}
                        />
                        Audio Experience
                    ...
                    {audioEnabled && (
                        <>
                            <div style={{ fontSize: 11, opacity: 0.7, marginTop: 2 }}>
                                Pulsating contemplative soundscape
                            </div>
                            <div style={{ marginTop: 6, fontSize: 11 }}>
                                <label style={{ display: 'block', marginBottom: 2 }}>
                                    Pulse Rate: {pulseRate.toFixed(2)} Hz
                                </label>
                                <input
                                    type="range"
                                    min="0.05"
                                    ...
                                    onChange={(e) => {
                                        ...
                                        // Update audio system pulse rate in real-time
                                        if (audioSystemRef.current) {
                                            audioSystemRef.current.setPulseRate(newRate);
                                        }
                                    }}
